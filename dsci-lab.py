...
#
# ## How to build the from scratch
#
# You don't have to build the VM from scratch by yourself. However, if you wish to do so, this would be the steps:
#
...
# * start `my-machne`; install a fresh Xubuntu; update the freshly installed machine to a current version
